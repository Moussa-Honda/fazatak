...
const AuthGate = ({ onAuthenticated, isExpired = false, initialUser = null }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-slate-950/95 backdrop-blur-xl flex items-center justify-center p-4 overflow-y-auto modal-safe-area" dir="rtl">
      ...
      <div className="w-full max-w-md bg-slate-900/95 rounded-3xl border border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.6)] overflow-hidden my-auto relative backdrop-blur-2xl">
        ...
        <div className="relative pt-8 pb-5 px-6 text-center overflow-hidden">
          ...
          <div className="relative mx-auto w-16 h-16 mb-3">
            ...
            <div className="relative w-16 h-16 bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl border border-emerald-500/40 shadow-inner flex items-center justify-center">
          ...
          <p className="text-slate-400 text-xs mt-1.5 font-medium">نظام التقسيط والجدولة — حساب العميل الموحد</p>
        </div>

        {/* Mode Selector Tabs (Login & Register) */}
        {mode !== 'expired' && (
          <div className="px-6 pb-2">
            <div className="flex bg-slate-950/90 p-1 rounded-2xl border border-slate-800/80">
              <button
                type="button"
          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-600 hover:from-emerald-500 hover:to-teal-500 disabled:opacity-50 text-white rounded-xl font-bold text-sm shadow-lg shadow-emerald-900/40 transition-all active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer mt-2"
              >
                {loading ? (
                  <>
          ...
          {mode === 'register' && (
            <form onSubmit={handleRegister} className="space-y-3.5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-600 hover:from-emerald-500 hover:to-teal-500 disabled:opacity-50 text-white rounded-xl font-bold text-sm shadow-lg shadow-emerald-900/40 transition-all active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer mt-1"
              >
                {loading ? (
                  <>
                    <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
        ...
        {/* Footer */}
        <div className="py-3.5 px-6 bg-slate-950/80 border-t border-slate-800/80 text-center flex items-center justify-center gap-2">

        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-4">
          ...
          <div className="bg-slate-700/50 rounded-xl p-4 border border-slate-600">
            ...
            <div className="flex justify-between mb-2">
              ...
              <span className="text-amber-400 font-bold">{contractRemaining.toLocaleString('en-US')} ر.س</span>
            </div>
            ...
            {excessAmount > 0 && (
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-3">
                <p className="text-blue-400 text-sm">
                  💡 سيتم توزيع الفائض ({excessAmount.toLocaleString('en-US')} ر.س) من آخر قسط في الجدول إلى الأعلى
                </p>
              </div>
            )}
            ...
            {shortageAmount > 0 && (
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-3">
                <p className="text-amber-400 text-sm">
                  ⚠️ سيتم تسجيل المبلغ كدفعة جزئية، والمتبقي ({shortageAmount.toLocaleString('en-US')} ر.س) يبقى على نفس القسط
                </p>
              </div>
            )}

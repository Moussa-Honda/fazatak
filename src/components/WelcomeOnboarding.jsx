...
const slides = [
  {
    ...
    subtitle: 'للأقساط والديون',
    description: 'نظامك الذكي لإدارة الأقساط والديون بكل سهولة واحترافية. تتبّع كل قسط، وكل عميل، في مكان واحد.',
  },
  {
    id: 1,
    icon: (
    ...
    description: 'أضف عملاءك، أنشئ عقودهم، وتابع أقساطهم بضغطة واحدة. تنبيهات تلقائية قبل موعد كل قسط.',
  },
  {
    id: 2,
    icon: (
    ...
    description: 'يُنبّهك التطبيق بالأقساط المستحقة اليوم، القريبة، والمتأخرة. راسل عملاءك عبر واتساب بنقرة واحدة.',
  },
  {
    id: 3,
    icon: (
    ...
    description: 'يحفظ التطبيق بياناتك تلقائياً ويزامنها على السحابة. لن تفقد شيئاً حتى لو غيّرت جهازك.',
  },
];
...
export default function WelcomeOnboarding({ onComplete }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] flex flex-col bg-slate-900 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative flex justify-between items-center px-6 pt-14 pb-2">
        ...
        {/* App name */}
        <span className="text-slate-600 text-xs font-bold tracking-widest uppercase">فزعتك</span>
      </div>
      ...
      >
        ...
        <div
          className={`relative flex items-center justify-center rounded-3xl p-6 mb-8 ${accent.bgLight} border ${accent.border} shadow-lg`}
          style={{
